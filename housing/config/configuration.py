...
class Configuration():
    ...
    def get_data_ingestion_config(self) -> DataIngestionConfig:
        try:
            ...
            data_ingested_dir = os.path.join(data_ingestion_artifact_dir,data_ingestion_info[DATA_INGESTION_INGESTED_DIR_NAME_KEY]
            )

            ingested_train_dir = os.path.join(data_ingested_dir,data_ingestion_info[DATA_INGESTION_TRAIN_DIR_KEY]
            )

            ingested_test_dir = os.path.join(data_ingested_dir,data_ingestion_info[DATA_INGESTION_TEST_DIR_KEY]
            )
